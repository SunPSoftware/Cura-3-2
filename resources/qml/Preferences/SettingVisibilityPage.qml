        ...
        ScrollView
        {
            ...
            ListView
            {
                ...
                model: UM.SettingDefinitionsModel
                {
                    ...
                    showAll: true
                    exclude: ["speed_wall","speed_wall_0","speed_wall_x","speed_roofing","speed_topbottom","speed_support","settable_per_extruder","speed_support_infill","speed_support_interface","speed_support_roof","speed_support_bottom","speed_prime_tower","speed_infill","speed_layer_0","speed_print_layer_0","speed_travel_layer_0","skirt_brim_speed","max_feedrate_z_override","speed_slowdown_layers","speed_equalize_flow_enabled","speed_equalize_flow_max","acceleration_enabled","acceleration_print","minimum_value_warning","acceleration_infill","acceleration_wall","acceleration_wall_0","acceleration_wall_x","acceleration_roofing","acceleration_topbottom","acceleration_support","acceleration_support_infill","acceleration_support_interface","acceleration_support_roof","acceleration_support_bottom","acceleration_prime_tower","acceleration_travel","acceleration_layer_0","acceleration_print_layer_0","acceleration_travel_layer_0","acceleration_skirt_brim","jerk_enabled","jerk_print","jerk_infill","jerk_wall","jerk_wall_0","jerk_wall_x","jerk_roofing","jerk_topbottom","jerk_support","jerk_support_infill","jerk_support_interface","jerk_support_roof","jerk_support_bottom","jerk_prime_tower","jerk_travel","jerk_layer_0","jerk_print_layer_0","jerk_travel_layer_0","jerk_skirt_brim",
