...
class CuraSplashScreen(QSplashScreen):
    ...
    def drawContents(self, painter):
        ...
        painter.save()
        painter.setPen(QColor(14, 17, 60, 255))
        ...
        painter.drawText(20, 66, 330 * self._scale, 230 * self._scale, Qt.AlignLeft | Qt.AlignTop, version[0])
        if len(version) > 1:
            font.setPixelSize(16)
            painter.setFont(font)
            painter.setPen(QColor(28, 28, 28, 255))
            painter.drawText(20, 105, 330 * self._scale, 255 * self._scale, Qt.AlignLeft | Qt.AlignTop, version[1])
        painter.setPen(QColor(28, 28, 28, 255))
        ...
        painter.setPen(pen)
        painter.drawArc(65, 140, 32 * self._scale, 32 * self._scale, self._loading_image_rotation_angle * 16, 300 * 16)
        ...
        if self._current_message:
            ...
            pen = QPen()
            pen.setColor(QColor(14, 17, 60, 255))
            painter.setPen(pen)
            painter.setFont(font)
            painter.drawText(20, 150, 170, 64,
